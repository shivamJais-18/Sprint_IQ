...
Users can create new Developer accounts from the SprintIQ Login page using **Create Account**. Successful registration automatically signs the new user in. Project Manager accounts remain restricted to authorized users and are not available through public registration.
